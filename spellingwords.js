// This is an expanded list of vocabulary words suitable for 3rd, 4th, and 5th-grade levels.
// Each word is an object containing the word itself and its definition.
// The list is alphabetized for easy reference.
const spellingWords = [
    ...
    { word: "analyze", definition: "To examine something in detail to understand it." },
    ...
    { word: "compare", definition: "To notice the similarities or differences of." },
    { word: "consequence", definition: "A result or effect of an action or condition." },
    { word: "contrast", definition: "To notice the differences between things." },
