export const anxietyLevelUpGame = {
    ...
    setup: function() {
        ...
        document.body.classList.add('anxiety-game-active');
    ...
    cleanup: function() {
        ...
        if (this.fontLink1) document.head.removeChild(this.fontLink1);
        if (this.fontLink2) document.head.removeChild(this.fontLink2);
        if (this.fontLink3) document.head.removeChild(this.fontLink3);
        this.styleElement = null;
        this.fontLink1 = null;
        this.fontLink2 = null;
        this.fontLink3 = null;
        
        document.body.classList.remove('anxiety-game-active');
